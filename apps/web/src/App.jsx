  ...
  return (
    <div className="page-wrapper">
      ...
      <header className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="site-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
          ...
          <nav>
            <ul className="nav-links">
              ...
              <li><a href="#example" className="nav-link">Use cases</a></li>
              <li><a href="#why-checkon" className="nav-link">Explore</a></li>
              <li><a href="#why-checkon" className="nav-link">Pricing</a></li>
            </ul>
          </nav>
      ...
      <main className="site-container">
        ...
        <section className="hero-section">
          <div className="hero-content">
            ...
            <div className="hero-trust-note">
              No credit card. No spam. Just meaningful updates.
            </div>
          </div>
        ...
        <section className="diff-showcase-section" id="example">
          <div className="diff-content">
            ...
            <h2 className="diff-headline">A real change.<br />A useful alert.</h2>
            <p className="diff-subtitle">
              Here's how a simple update looks on CheckOn.
            </p>
            <div>
              <button 
                className="btn-hero-primary"
          ...
          <div className="features-grid">
            ...
            <div className="feature-box">
              ...
              <p className="feature-text">
                News, product pages, documentation, listings — anything.
              </p>
            </div>
            ...
            <div className="feature-box">
              ...
              <p className="feature-text">
                One watch. Many subscribers. Keep your community informed.
              </p>
            </div>
            ...
            <div className="feature-box">
              ...
              <p className="feature-text">
                Filter out the noise. Get updates that actually matter.
              </p>
            </div>
            ...
            <div className="feature-box">
              ...
              <p className="feature-text">
                We check regularly, so you don't have to.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="cta-banner-card">
            <div className="cta-banner-left">
              <svg className="cta-curved-arrow" viewBox="0 0 44 44" fill="none" stroke="currentColor">
                <path d="M 8 36 C 8 16, 20 8, 36 8 M 28 2 L 38 8 L 28 14" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <img 
                src="/assets/cta-callout.png" 
                alt="Stop checking. Start knowing." 
                className="cta-callout-img" 
              />
            </div>
            ...
            <div className="cta-banner-right">
              ...
              <img 
                src="/assets/accent-burst.png" 
                alt="" 
                className="cta-burst-ray" 
              />
            </div>
          </div>
        </section>
      ...
      <footer className="site-container">
        <div className="footer-wrap">
          ...
          <div className="footer-tagline">
            A more informed internet, together.
          </div>
        </div>
      </footer>
